local github_api = http.get(
	"https://api.github.com/repos/9551-Dev/orbital-sandbox/git/trees/main?recursive=1",
...
for k,v in pairs(list.tree) do
    if v.type == "blob" and v.path:lower():match(".+%.lua") then
        ls["https://raw.githubusercontent.com/9551-Dev/orbital-sandbox/main/"..v.path] = v.path
        len = len + 1
    end
end
...
print("Finished downloading orbital sandbox")
